...
#define UGC_SET_PTR(ptr, val)                          \
    do                                                 \
    {                                                  \
        ptr = (void *)((uintptr_t)val | UGC_TAG(ptr)); \
    } while (0)
#define UGC_SET_TAG(ptr, val)                          \
    do                                                 \
    {                                                  \
        ptr = (void *)(UGC_PTR(ptr) | (uintptr_t)val); \
    } while (0)
...
void ugc_init(ugc_t *gc, ugc_visit_fn_t scan_fn, ugc_visit_fn_t release_fn)
{
    ugc_clear(&gc->set1);
    ugc_clear(&gc->set2);
...
void ugc_visit(ugc_t *gc, ugc_header_t *obj)
{
